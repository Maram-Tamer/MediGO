        ...
        if (state is AuthSuccessState) {
          pop(context);
           if(FirebaseAuth.instance.currentUser!.displayName != null){
             state.userType==UserType.hospital?pushTo(context: context, route: Routes.Main_hospital):pushTo(context: context, route: Routes.Main_patient);
          }else{
            state.userType==UserType.hospital?pushTo(context: context, route: Routes.Hospital_Step_1):pushTo(context: context, route: Routes.Patient_Step_1);
          }
