                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: MainButton(
                          buttonText: 'Sign Up',
                          onPressed: () {
                            if (cubit.formKey.currentState!.validate()&&isChecked&&cubit.passwordController.text==cubit.confirmPasswordController.text) {
                              cubit.userType = (widget.routeAfterRegister==Routes.Hospital_Step_1)?UserType.hospital:UserType.patient;
                            cubit.signup();
                            }
                          },
                        ),
